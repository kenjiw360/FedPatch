...
from torch.multiprocessing import Process, Condition, Array
import argparse
import threading
import os
...
if __name__ == "__main__":
	...
	server_thread = threading.Thread(target=server_threading_lambda, args=(args,server_condition))
	server_thread.start()
	...
	client_pool = [Process(target=client_threading_lambda, args=(i, dataset, occupied, client_condition, server_condition, args)) for i, dataset in enumerate(client_datasets)]
